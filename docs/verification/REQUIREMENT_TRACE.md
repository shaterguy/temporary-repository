...
- The selected `snare` module exposes a boundary-inclusive movement multiplier area; the default `ark_ward` module halves visible damage only while the defended position lies inside an active ward.
